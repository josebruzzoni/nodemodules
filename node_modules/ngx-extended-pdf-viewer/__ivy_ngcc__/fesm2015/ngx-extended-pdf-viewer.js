...
import { Component, Injectable, ViewEncapsulation, Input, Output, EventEmitter, ChangeDetectionStrategy, HostListener, ViewChild, NgZone, Inject, PLATFORM_ID, ElementRef, ChangeDetectorRef, Pipe, Renderer2, NgModule, defineInjectable } from '@angular/core';
...
/** @type {?} */
let pdfjsVersion = '2.6.423';
/** @type {?} */
let pdfjsBleedingEdgeVersion = '2.7.537';
/**
 * @param {?} folder
 * @return {?}
 */
...
PdfSidebarComponent.ɵcmp = ɵngcc0.ɵɵdefineComponent({ type: PdfSidebarComponent, selectors: [["pdf-sidebar"]], inputs: { sidebarVisible: "sidebarVisible", showSidebarButton: "showSidebarButton", sidebarPositionTop: "sidebarPositionTop", customSidebar: "customSidebar", customThumbnail: "customThumbnail" }, outputs: { thumbnailDrawn: "thumbnailDrawn" }, ngContentSelectors: _c0, decls: 4, vars: 1, consts: [[4, "ngTemplateOutlet"], ["defaultSidebar", ""], ["id", "sidebarContainer"], ["id", "additionalSidebarContainer"], [3, "customThumbnail", "hideSidebarToolbar", "thumbnailDrawn"], ["id", "sidebarResizer", 1, "hidden"]], template: function PdfSidebarComponent_Template(rf, ctx) { if (rf & 1) {
    ...
    } }, directives: function () { return [ɵngcc1.NgTemplateOutlet, PdfSidebarToolbarComponent,
        PdfSidebarContentComponent]; }, styles: [""] });
/** @nocollapse */
...
NgxExtendedPdfViewerComponent.ɵcmp = ɵngcc0.ɵɵdefineComponent({ type: NgxExtendedPdfViewerComponent, selectors: [["ngx-extended-pdf-viewer"]], viewQuery: function NgxExtendedPdfViewerComponent_Query(rf, ctx) { if (rf & 1) {
        ...
        ɵngcc0.ɵɵadvance(1);
        ɵngcc0.ɵɵproperty("ngIf", ctx.hasSignature);
        ɵngcc0.ɵɵadvance(1);
        ɵngcc0.ɵɵstyleProp("background-color", ctx.backgroundColor);
    } }, directives: function () { return [ɵngcc1.NgIf, DynamicCssComponent, ɵngcc1.NgTemplateOutlet, PdfSidebarComponent,
        ...
        PdfLightThemeComponent]; }, pipes: function () { return [ɵngcc1.AsyncPipe, TranslatePipe]; }, encapsulation: 2, changeDetection: 0 });
NgxExtendedPdfViewerComponent.ngxExtendedPdfViewerInitialized = false;
/** @nocollapse */
...
NgxExtendedPdfViewerServerComponent.ɵcmp = ɵngcc0.ɵɵdefineComponent({ type: NgxExtendedPdfViewerServerComponent, selectors: [["ngx-extended-pdf-viewer"]], viewQuery: function NgxExtendedPdfViewerServerComponent_Query(rf, ctx) { if (rf & 1) {
        ...
        PdfDummyComponentsComponent,
        PdfDarkThemeComponent,
        PdfLightThemeComponent]; }, encapsulation: 2, changeDetection: 0 });
...
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && ɵngcc0.ɵɵsetNgModuleScope(NgxExtendedPdfViewerCommonModule, { declarations: function () { return [DynamicCssComponent,
        ...
        TranslatePipe]; }, imports: function () { return [CommonModule, FormsModule]; }, exports: function () { return [PdfZoomDropdownComponent,
        PdfContextMenuComponent,
        PdfPresentationModeComponent,
        PdfOpenFileComponent,
        PdfPrintComponent,
...
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && ɵngcc0.ɵɵsetNgModuleScope(NgxExtendedPdfViewerModule, { declarations: function () { return [NgxExtendedPdfViewerComponent]; }, imports: function () { return [NgxExtendedPdfViewerCommonModule,
        CommonModule, FormsModule]; }, exports: function () { return [PdfZoomDropdownComponent,
        PdfContextMenuComponent,
        PdfPresentationModeComponent,
        PdfOpenFileComponent,
        PdfPrintComponent,
...
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && ɵngcc0.ɵɵsetNgModuleScope(NgxExtendedPdfViewerServerModule, { declarations: function () { return [NgxExtendedPdfViewerServerComponent]; }, imports: function () { return [NgxExtendedPdfViewerCommonModule,
        CommonModule, FormsModule]; }, exports: function () { return [PdfZoomDropdownComponent,
        PdfContextMenuComponent,
        PdfPresentationModeComponent,
        PdfOpenFileComponent,
